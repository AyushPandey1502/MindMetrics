...
const analysisScorePrompt =
  "Rate the mental health of the user in a scale of 1 to 10 where 10 is best and 1 is worst based on the previous chats from the user. Just reply the number in the scale 1 to 10, no other things. You are strictly forbidden to reply any other thing than a number.";
